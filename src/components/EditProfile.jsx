...
import { Container, FormControlLabel, Checkbox, FormControl,InputLabel, Select, MenuItem, Card, CardContent, TextField, Button, Typography, styled } from '@mui/material';
...
console.warn(CustomButton, CustomTextField);
function EditProfile(props) {
  ...
  useEffect(() => {
    fetch(`https://yog-backend-bsnv3bb4fa-uc.a.run.app/users/${localStorage.getItem("user_id")}`, {
      method: "GET",
      headers: {
          ...
          <Card style={{ backgroundColor: '#292929', marginBottom: '20px', padding: '15px' }}>
              <CardContent>
                  ...
                  <FormControl fullWidth margin="normal" variant="outlined">
                      ...
                      >
                          {['fruits', 'vegetables', 'rice', 'chicken','milk','oats','eggs','fish'].map((item) => (
