...
function LoginPage() {
    ...
    const handleSubmit = async (e) => {
        await fetch(`https://yog-backend-bsnv3bb4fa-uc.a.run.app/users?username=${username}`, {
            method: 'GET',
            headers: {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minHeight: '100vh', backgroundColor: '#151515', color: 'white', padding: '20px' }}>
      ...
      <CustomTextField variant="outlined" label="Username:" fullWidth sx={{ marginY: 1, width: '80%' }} 
        value={username}
