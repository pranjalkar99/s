import { Container, Typography, Card, CardContent, Box, Button, styled } from '@mui/material';
      ...
      {!props.loading &&
          ...
          <Card style={{ backgroundColor: '#292929', marginBottom: '20px' }}>
              <CardContent>
                  ...
                  <Typography style={{ color: "#FFFFFF" }}>Height:(in cm) {user.height} cm</Typography>
                  <Typography style={{ color: "#FFFFFF" }}>Weight:(in kg) {user.weight} kg</Typography>
